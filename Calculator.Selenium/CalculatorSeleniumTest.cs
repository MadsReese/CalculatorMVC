...
namespace Calculator.Selenium
{
	...
	public class CalculatorSeleniumTest
	{
        ...
        **/
		...
		[Test]
		public void CalculatorSeleniumTest30and20is50()
		{
        ...
        [Test]
        public void CalculatorSeleniumTest40and10is50()
        {
            driver.Navigate().GoToUrl(baseURL);
            driver.FindElement(By.XPath("//*[@id='FirstNumber']")).Clear();
            driver.FindElement(By.XPath("//*[@id='FirstNumber']")).SendKeys("40");
            driver.FindElement(By.XPath("//*[@id='SecondNumber']")).Clear();
        ...
        [Test]
        public void CalculatorSeleniumTest1and1is2()
        {
            driver.Navigate().GoToUrl(baseURL);
            driver.FindElement(By.XPath("//*[@id='FirstNumber']")).Clear();
            driver.FindElement(By.XPath("//*[@id='FirstNumber']")).SendKeys("1");
            driver.FindElement(By.XPath("//*[@id='SecondNumber']")).Clear();
